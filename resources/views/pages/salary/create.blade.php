...
@section('content')
<form action="{{route('view.salary.store')}}" method="post" enctype="multipart/form-data" class="container-fluid">
    @csrf
    <!-- Page Header -->
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        ...
        <div class="main-dashboard-header-right">
            <div class="d-flex my-xl-auto right-content align-items-center">
                <div>
                    <a href="{{route('view.salary.index')}}" class="btn btn-danger btn-icon me-2 btn-b" title="Quay lại danh sách salary">
